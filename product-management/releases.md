...
* Er zijn ook diverse problemen opgelost, waaronder: dropdownlijsten en veldselecties worden correct weergegeven, nieuwe conceptversies van zaken met building blocks kunnen weer worden aangemaakt, procesinformatie wordt volledig getoond in definitieve versies, zoekresultaten houden correct rekening met toegangsrechten, procesnamen worden volledig weergegeven en wijzigingen aan form flows en building block-configuraties worden correct opgeslagen.
...
* Bij het koppelen van een zaaktype worden nu ook de begin- en einddatum van het zaaktype getoond, waardoor verschillende versies eenvoudiger van elkaar te onderscheiden zijn.
* Daarnaast is een nieuwe optie toegevoegd om Form.io-tokens alleen tijdens de sessie in het geheugen te bewaren.
